...
export type AdminSession = Schemas['AdminSessionSummaryResponse'];
export type AdminSessionSettings = Schemas['AdminSessionSettingsResponse'];
export type AdminSessionSettingsRequest = Schemas['AdminSessionSettingsRequest'];
